...
public class SmsUtil {
    ...
    private static String templateCode = "SMS_148380226";

    public static SendSmsResponse sendSms(String phoneNumber,String machineName) throws ClientException {
        ...
        request.setTemplateParam("{\"name\":\" " + machineName + " \"}");
