...
public class QueryDeviceServiceImpl implements QueryDeviceService {
    ...
    public ResponseData addDeviceInfo(InteractionData interactionData, HttpSession httpSession) {
        String deviceName = interactionData.getDeviceInfo().getDeviceName();
        double deviceWorkPower = interactionData.getDeviceInfo().getDeviceWorkPower();
        double standbyPower = interactionData.getDeviceInfo().getDeviceWorkPower();
        String uuid = interactionData.getDeviceUuid().getUuid();
     ...
     */
    @Override
    public ResponseData delDeviceInfo(InteractionData interactionData, HttpSession httpSession) {
        return null;
    }
}
